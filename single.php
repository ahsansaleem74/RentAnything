...
$conn = mysqli_connect("localhost","root","","rentanything")
 		...
 		$sql = "SELECT  * FROM tblads where adId = '$pID'";
...
<body>
		...
		<div class="container">
			<div class="product-desc">
				<div class="col-md-7 product-view">
					...
					<p> <i class="glyphicon glyphicon-map-marker"></i> <a href="#"><?php echo $row['adCity']; ?></a>| Added at <?php echo $row['time']; ?>, <?php echo $row['date']; ?></p>
					<div class="flexslider"><?php echo $row['adPrice']; ?>
						<ul class="slides">
							<li data-thumb="serverphotos/<?php echo $row['adImage']; ?>">
								<img src="serverphotos/<?php echo $row['adImage']; ?>" />
							</li>
							<li data-thumb="serverphotos/<?php echo $row['coverImage']; ?>">
								<img src="serverphotos/<?php echo $row['coverImage']; ?>" />
							</li>
					...
					<div class="product-details">
						<h4><span class="w3layouts-agileinfo">Brand </span> : <a href="#"><?php echo $row['adCategory']; ?></a><div class="clearfix"></div></h4>
					
						<h4><span class="w3layouts-agileinfo">Summary</span> :<p><?php echo $row['adDescription']; ?></p><div class="clearfix"></div></h4>
				...
				<div class="col-md-5 product-details-grid">
					<div class="item-price">
						<div class="product-price">
							...
							<h3 class="rate">RS <?php echo $row['adPrice']; ?></h3>
							<div class="clearfix"></div>
						</div>
						<div class="condition">
							<p class="p-price">Condition</p>
							<h4><?php echo $row['adcondition']; ?></h4>
							<div class="clearfix"></div>
						</div>
						<div class="itemtype">
							<p class="p-price">Item Type</p>
							<h4><?php echo $row['adCategory']; ?></h4>
							<div class="clearfix"></div>
						</div>
					</div>
					<div class="interested text-center">
						<h4>Are you Interested in this Ad?<small> Contact the Seller!</small>
							<br>
							<br>
							<br>
							<form action='' method='post'>
							...
							<p><i class="glyphicon glyphicon-earphone"></i><?php echo $row['phoneNumber']; ?></p>
						</h4>
						</div>
										</div>
			<div class="clearfix"></div>
	...
	if(isset($_POST['btnrequest'])){
		...
		$sql1 = "SELECT * FROM tbluser where userEmail = '$user_email'";
		...
		$user_id = $row1['Id'];
 		...
 		$sql = "INSERT INTO rentedads(adId, Id,adPrice,adDescription,adDays,adDate) VALUES ('{$pID}', '{$user_id}', '{$adprice}', '{$ades}', '{$rentstatus}', '{$addate}')";
						...
						<div class="col-md-3 wthree-footer-grid">
							...
							<address>
								...
								<ul class="location">
									...
									<li><a href="mailto:info@example.com">Rentanything@gmail.com</a></li>
								</ul>						
							</address>
						</div>
						<div class="clearfix"></div>
