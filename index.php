			...
			<ul class="rslides" id="slider">
				<li>
					<div class="w3ls-slide-text">
						...
						<a href="allAds.php" class="w3layouts-explore-all">Browse all Categories</a>
					</div>
				</li>
				<li>
					<div class="w3ls-slide-text">
...
echo "<span class='price'>".$row['adPrice']."</span>";
echo "</a> ";
echo "<div class='w3-ad-info'>";
echo "<h5>".$row['adTitle']."</h5>";
