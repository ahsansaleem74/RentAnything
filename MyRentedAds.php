...
<?php
		...
		$sql1 = "SELECT * FROM tbluser where userEmail = '".$email."'";
 		...
 		$sql = "SELECT  * FROM rentedads where Id = ".$user_id;
    ...
    <tbody>
    	<?php
    		while($row = mysqli_fetch_assoc($result)){
				...
				$sql1 = "SELECT * FROM tbluser where Id = ".$row['Id']."";
				$result1 = $conn->query($sql1);
				if(mysqli_num_rows($result1) > 0 ){
					$row1 = mysqli_fetch_assoc($result1);
				...
				$sql12 = "SELECT * FROM tblads where adId = ".$row['adId']."";
      ...
      <tr>
        ...
        <td><?php echo $row12['adTitle'] ?></td>
        
        <td><?php echo $row['adDescription']?></td>
        <td><?php echo $row['adPrice'] ?></td>
        <td><?php echo $row['adDays']?></td>
