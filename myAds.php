...
<table class="table">
	<?php
		...
		$user_email = $_SESSION["user_Email"];
 		...
 		$sql = "SELECT  adId, fullName, adtitle, adPrice, adcondition,adcategory, rentStatus,adcity,itemAvailability FROM tblads where emailAddress = '".$user_email."' ";
 ...
 ?> 
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo $row['adPrice'] ?>  </td>
        <td><?php echo $row['adcondition'] ?>  </td>
        <td><?php echo $row['adcategory'] ?>  </td>
       <td><?php echo $row['adcity'] ?>  </td>
       <td><?php echo $row['rentStatus'] ?>  </td> 


        <td>
        <a href='delete.php?id=<?php echo $row['adId']; ?>'>Delete</a>
        </td>
		...
		<footer>
			...
			<div class="container">
				...
				<div class="copyrights">
					<p> © 2021 RentAnything   <a href="index.php">  Rent Anything</a></p>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
